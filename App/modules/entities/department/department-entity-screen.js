...
class DepartmentEntityScreen extends React.PureComponent {
  ...
  *************************************************************/
  ...
  renderEmpty = () =>
    <AlertMessage title='No Departments Found' show={!this.props.fetching} />
  ...
  fetchDepartments = () => {
    this.props.getAllDepartments({ page: this.state.page, sort: this.state.sort, size: this.state.size })
  }
  ...
  componentWillReceiveProps (newProps) {
    if (newProps.departments) {
      this.setState({
        done: newProps.departments.length < this.state.size,
        dataObjects: this.state.loading ? [...this.state.dataObjects, ...newProps.departments] : newProps.departments,
        loading: false
      })
    }
  }
