...
class EmployeeEntityScreen extends React.PureComponent {
  ...
  *************************************************************/
  ...
  renderEmpty = () =>
    <AlertMessage title='No Employees Found' show={!this.props.fetching} />
  ...
  fetchEmployees = () => {
    this.props.getAllEmployees({ page: this.state.page, sort: this.state.sort, size: this.state.size })
  }
  ...
  componentWillReceiveProps (newProps) {
    if (newProps.employees) {
      this.setState({
        done: newProps.employees.length < this.state.size,
        dataObjects: this.state.loading ? [...this.state.dataObjects, ...newProps.employees] : newProps.employees,
        loading: false
      })
    }
  }
