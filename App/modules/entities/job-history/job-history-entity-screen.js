...
class JobHistoryEntityScreen extends React.PureComponent {
  ...
  *************************************************************/
  ...
  renderEmpty = () =>
    <AlertMessage title='No JobHistories Found' show={!this.props.fetching} />
  ...
  fetchJobHistories = () => {
    this.props.getAllJobHistories({ page: this.state.page, sort: this.state.sort, size: this.state.size })
  }
  ...
  componentWillReceiveProps (newProps) {
    if (newProps.jobHistories) {
      this.setState({
        done: newProps.jobHistories.length < this.state.size,
        dataObjects: this.state.loading ? [...this.state.dataObjects, ...newProps.jobHistories] : newProps.jobHistories,
        loading: false
      })
    }
  }
