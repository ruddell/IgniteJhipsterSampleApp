...
class CountryEntityScreen extends React.PureComponent {
  ...
  *************************************************************/
  ...
  renderEmpty = () =>
    <AlertMessage title='No Countries Found' show={!this.props.fetching} />
  ...
  componentWillReceiveProps (newProps) {
    if (newProps.countries) {
      this.setState({
        done: newProps.countries.length < this.state.size,
        dataObjects: this.state.loading ? [...this.state.dataObjects, ...newProps.countries] : newProps.countries,
        loading: false
      })
    }
  }
