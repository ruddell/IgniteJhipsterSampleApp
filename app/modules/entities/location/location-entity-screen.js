...
class LocationEntityScreen extends React.PureComponent {
  ...
  *************************************************************/
  ...
  renderEmpty = () =>
    <AlertMessage title='No Locations Found' show={!this.props.fetching} />
  ...
  fetchLocations = () => {
    this.props.getAllLocations({ page: this.state.page, sort: this.state.sort, size: this.state.size })
  }
  ...
  componentWillReceiveProps (newProps) {
    if (newProps.locations) {
      this.setState({
        done: newProps.locations.length < this.state.size,
        dataObjects: this.state.loading ? [...this.state.dataObjects, ...newProps.locations] : newProps.locations,
        loading: false
      })
    }
  }
